...
<div class="container">
    ...
    <div class="row">
                        ...
                        <c:forEach items="${p_list }" var="p">
	                        <tr>
	                           ...
	                           <%--  <td>
	                            ...
	                            <td>
	                            	<select class="form-control tableIpt" name="flag">
	                            		<option value="1" <c:if test="${p.flag == 1 }">selected</c:if> >有效</option>
	                            		<option value="2" <c:if test="${p.flag == 2 }">selected</c:if>>无效</option>
	                            	</select>
	                            </td>
	                            <td style="text-align:center">
	                                <span item_id="${p.id }" style="color:#337ab7" class="edit">保存</span>
	                            </td>
	                        </tr>
                        </c:forEach>
                        </tbody>
        ...
        <input type="hidden" id="footKey" value="${footKey }">
    </div></div>
...
<div id="mask">
    <div class="simpleAlertBody" style="width: 85%;left: 7%;height: 280px;">
        ...
        <form id="addForm" action="addServiceItem" method="post">
	        ...
	        <button type="submit" class="simpleAlertBtn simpleAlertBtn2" style="   left: 16%;background-color: #48a3da;color:#fff;width:200px">确&nbsp;&nbsp;&nbsp;&nbsp;定</button>
		</form>
    </div>
</div>
<div id="mask2">
...
<script>
	$("table").delegate(".edit","click",function(){
		...
		var flag = $(this).parent().siblings("td").find("select[name='flag']").val();	
